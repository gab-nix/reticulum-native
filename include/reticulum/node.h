...
typedef enum {
    ...
    RNS_NODE_REASON_NO_LINK,
    RNS_NODE_REASON_LINK_NOT_VALIDATED,
    RNS_NODE_REASON_WRONG_LINK_INTERFACE,
    RNS_NODE_REASON_WRONG_LINK_HOPS,
    RNS_NODE_REASON_INVALID_LINK_PROOF,
