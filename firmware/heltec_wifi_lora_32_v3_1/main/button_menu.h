...
#include <stdbool.h>
#include <stdint.h>
typedef enum { HELTEC_MENU_NONE, HELTEC_MENU_ANNOUNCE, HELTEC_MENU_MESSAGE, HELTEC_MENU_CLEAR, HELTEC_MENU_NODES, HELTEC_MENU_NEXT, HELTEC_MENU_CHANNEL } heltec_menu_action;
typedef struct {
