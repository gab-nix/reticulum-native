...
| Nomad conversations | WIP | Verified-peer opportunistic send and receive, search, trust tabs, address entry, known-node inbox handoff, composer, history and offline queue exist. Attachments, replies, reactions, receipts and non-opportunistic delivery remain. |
