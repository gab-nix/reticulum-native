...
| Native Micron browser | WIP | Bounded parser, links, history, strict Reticulum request/response MessagePack codecs, and runtime packet-response receipts with correlation, cancellation, size limits and deadlines exist. Remote fetch orchestration, resource-backed responses, forms, complete markup and upstream page tests remain. |
