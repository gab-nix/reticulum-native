...
| Heltec live inbox and node browsing | WIP | Verified discovery and message callbacks exist; scrolling multi-message history and a selectable live node view are not yet wired into the OLED application. Current message recall retains only one bounded preview in volatile RAM |
