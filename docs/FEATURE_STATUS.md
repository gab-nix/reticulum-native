...
| Ticket fields composition | IMPLEMENTED | `test_lxmf_fields` covers add/replace/remove, opaque field preservation, 64-bit expiry, bounds and malformed input; issuance/delivery scheduling remains |
